...
import { FaRegEnvelope, FaLaptopCode, FaUserTie, FaRegSmileBeam, FaHandsHelping, FaTrophy, FaMoneyBillAlt } from "react-icons/fa";
...
const JoinPage = () => {
  const jobPositions = [
    {
      ...
      description: "We're looking for a skilled frontend developer with experience in React and JavaScript to help build and maintain our user interface.",
      icon: <FaLaptopCode className="w-8 h-8 text-blue-500" />,
    },
    {
      title: "Marketing Specialist",
      description: "We need a creative marketing specialist to help promote our app and reach out to potential users and partners.",
      icon: <FaUserTie className="w-8 h-8 text-blue-500" />,
    },
    {
      title: "Community Manager",
      description: "Are you passionate about community engagement? We're seeking a community manager to foster a vibrant and supportive community around our platform.",
  ...
  const perksList = [
    {
      ...
      description: "Join a team that values collaboration, creativity, and a positive attitude. We strive to create a friendly and inclusive workplace for everyone.",
    },
    {
      icon: <FaHandsHelping className="w-10 h-10 text-white" />,
      title: "Opportunities to Grow",
      description: "We believe in nurturing talent and providing opportunities for professional growth and skill development.",
    },
    {
      icon: <FaTrophy className="w-10 h-10 text-white" />,
      title: "Recognition and Rewards",
      description: "Your hard work and contributions will be acknowledged and rewarded to show our appreciation for your efforts.",
    },
    {
      icon: <FaMoneyBillAlt className="w-10 h-10 text-white" />,
      title: "Competitive Compensation",
      description: "Enjoy a competitive salary package and additional benefits as part of your commitment to our team.",
    },
  ];
  ...
  return (
      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="text-center flex justify-center flex-col items-center">
            <h2 className="text-6xl font-extrabold text-gray-900 font-outfit">Join Our <span className="text-blue-500">Team</span></h2>
            <p className="mt-4 text-lg text-gray-600 w-2/3">
              We are always on the lookout for talented individuals who share our mission to provide equal access to quality extracurricular opportunities for all high school students. Join us and make a difference!
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 mt-12 md:grid-cols-2 lg:grid-cols-3">
            {jobPositions.map((position, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white font-outfit">{position.title}</h3>
                <p className="mt-2 text-lg text-gray-100">{position.description}</p>
                <button
      ...
      <div className="flex space-x-4">
        ...
        <div className="w-[45%]">
          <div className="bg-blue-500 p-4 rounded-lg flex">
            ...
            <div>
              <h3 className=" text-white text-xl">Positive Work Environment</h3>
    ...
    <section className="bg-gradient-to-r from-purple-700 via-indigo-700 to-blue-700 py-10 mx-5 lg:mx-20 rounded-xl shadow-lg z-40 mb-10">
        <div className="text-center text-4xl font-bold tracking-normal sm:text-6xl pb-10 text-white font-outfit">Get in Touch</div>
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div className="flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-lg text-center h-full">
              ...
              <h3 className="text-2xl font-bold text-gray-900 font-outfit">General Inquiries</h3>
              <p className="mt-2 text-lg text-gray-600">
                For any general questions or feedback, feel free to reach out to us. We'd love to hear from you!
              </p>
              <a
            ...
            <div className="flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-lg text-center h-full">
              ...
              <h3 className="text-2xl font-bold text-gray-900 font-outfit">Technical Support</h3>
              <p className="mt-2 text-lg text-gray-600">
                Encountering issues or need technical assistance? Our support team is here to help you.
              </p>
              <a
