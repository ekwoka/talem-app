  ...
  let gradeItems = [
    {
      id: 'allgrades',
      text: 'All Grades',
      tooltip: 'Search for activites for All Grades',
    },
    {
      id: 'grade9',
      text: 'Freshman',
      tooltip: 'Search for activites ONLY for Freshman',
    },
    {
      id: 'grade10',
      text: 'Sophomore',
      tooltip: 'Search for activites ONLY for Sophomores',
    },
    {
      id: 'grade11',
      text: 'Junior',
      tooltip: 'Search for activites ONLY for Juniors',
    },
    {
      id: 'grade12',
      text: 'Senior',
      tooltip: 'Search for activites ONLY for Seniors',
    },
  ];
            ...
            <div className="col-span-1">
              <div className="shadow-[0_0_10px_-7px] rounded-lg flex flex-col justify-center items-center py-4 mb-4">
                <div className="filter bg-gradient-to-r from-yellow-300 to-yellow-500">
                  <div
                    ...
                    onClick={() => handleGrade('settingState')}>
                    Settings
                  ...
                  {dropState.settingState && (
                    <>
                      <div className="w-full p-3 my-2 flex flex-col justify-center items-center gap-4 relative">
                        <button
                          className="w-9/12 bg-blue-500 p-3 rounded-md shadow-md font-outfit text-white flex justify-between"
                          onClick={() => changeAllDropdownState(false)}>
                          Close All Filters{' '}
                          <XCircleIcon className="dropdown-main" />
                        </button>
                        <button
                          className="w-9/12 bg-blue-500 p-3 rounded-md shadow-md font-outfit text-white flex justify-between"
                          onClick={() => changeAllDropdownState(true)}>
                          Open All Filters{' '}
                          <PlusCircleIcon className="dropdown-main" />
                        </button>
                        <button
                          className="w-9/12 bg-blue-500 p-3 rounded-md shadow-md font-outfit text-white flex justify-between"
                          onClick={props.resetValues}>
                          Clear All Filters{' '}
                          <TrashIcon className="dropdown-main" />
                        </button>
                      </div>
                    </>
                  )}
              ...
              <div className="shadow-[0_0_10px_-7px] rounded-lg flex flex-col justify-center items-center py-4">
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('gradeState')}>
                    Sort by Grade:
                    {dropState.gradeState ? (
                      <MinusCircleIcon className="dropdown-main" />
                    ) : (
                      <PlusCircleIcon className="dropdown-main" />
                    )}
                  </div>
                          ...
                          <div className="w-full group relative">
                            <div className="flex items-center mb-4">
                              <input
                                ...
                                name={item.id}
                                type="checkbox"
                                onChange={() => props.filterChange(item.id)}
                                checked={props.checkVal[item.id]}
                                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                              />
                              <label
                                htmlFor={item.id}
                                className="ml-2 text-lg text-gray-900 dark:text-gray-300 font-medium font-outfit">
                                {item.text}
                              </label>
                            </div>
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('environmentState')}>
                      ...
                      <div className="w-full">
                        <div className="flex items-center mb-4">
                          <input
                            id="inperson"
                            type="checkbox"
                            onChange={() => props.filterChange('inperson')}
                            checked={props.checkVal['inperson']}
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          />
                          <label
                            htmlFor="inperson"
                      ...
                      <div className="w-full">
                        <div className="flex items-center mb-4">
                          <input
                            id="remote"
                            type="checkbox"
                            onChange={() => props.filterChange('remote')}
                            checked={props.checkVal['remote']}
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          />
                          <label
                            htmlFor="remote"
                      ...
                      <div className="w-full">
                        <div className="flex items-center mb-4">
                          <input
                            id="hybrid"
                            type="checkbox"
                            onChange={() => props.filterChange('hybrid')}
                            checked={props.checkVal['hybrid']}
                            className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          />
                          <label
                            htmlFor="hybrid"
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('companyState')}>
                    Company Type
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('durationState')}>
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('teamIndividualState')}>
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('skillLevelState')}>
                    Skill Level
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('locationState')}>
                ...
                <div className="filter">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('activityCategoryState')}>
                    Activity Category
              ...
              <div className="shadow-[0_0_10px_-7px] rounded-lg flex flex-col justify-center items-center py-4 mt-4">
                ...
                <div className="filter bg-gradient-to-r from-green-300 to-green-500">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('generalFilterState')}>
                ...
                <div className="filter bg-gradient-to-r from-purple-300 to-purple-600">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('programmingState')}>
                    Programming/Tech
                ...
                <div className="filter bg-gradient-to-r from-purple-300 to-purple-600">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('engineeringState')}>
                    Engineering/Design
                ...
                <div className="filter bg-gradient-to-r from-purple-300 to-purple-600">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('mathScienceState')}>
                    Mathematics/Science
                ...
                <div className="filter bg-gradient-to-r from-purple-300 to-purple-600">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('businessSocialState')}>
                ...
                <div className="filter bg-gradient-to-r from-purple-300 to-purple-600">
                  <div
                    className="filter-title"
                    onClick={() => handleGrade('humanityArtState')}>
                    Humanities (+ Art)
            ...
            <div className="col-span-3 shadow-[0_0_10px_-7px]">
              ...
              <div className="relative flex">
                <div className="w-full p-7 pb-2 flex justify-around">
                  <input
                    ...
                    className="w-[85%] xl:w-[95%] p-4 text-base text-gray-900 border border-none shadow-xl rounded-lg bg-slate-100 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-outfit"
                    placeholder="Search for a specific extracurricular (Ex: Robotics)"
                    required
                  />
                  <div
                    onClick={handleBookmarkVal}
                    className="relative p-2 w-[15%] xl:w-[5%] mx-2 shadow-xl rounded-lg bg-slate-100 flex justify-center items-center text-center border-2 font-outfit text-md cursor-pointer hover:border-2 hover:border-cyan-600">
                    <BookmarkIcon className="w-6 h-6" />
                    <div className="absolute -top-3 -right-4 py-1 px-3 bg-cyan-600 text-white rounded-full">
              ...
              {showBanner && (
                <div className="relative mx-8 bg-yellow-300 py-2 my-2 font-outfit px-6 rounded-lg text-yellow-800 text-center shadow-md">
                  <div
                    className="absolute text-3xl top-0 right-[8px] text-yellow-800 cursor-pointer rotate-45 hover:text-black"
                    onClick={() => setShowBanner(false)}>
                    +
                  </div>
                  Hi there, I'm Pranav! I'm the developer of{' '}
                  <span className="text-blue-700">Talem</span> and I'm glad
                  you're using it/finding it useful! If you want to support me
                  you can do so by{' '}
                  <span className="">
                    <a
                      href="https://pranavk.vercel.app"
                      target="_blank"
                    ...
                    ,{' '}
                    <a
                      href="https://discord.gg/tP97h8kWUx"
                      className="text-blue-700 underline"
                      target="_blank"
                      rel="noreferrer">
                      or joining Talem's discord server!
                    </a>{' '}
                  </span>
                  (You can get rid of this message by clicking the "X" at the
                  top right. It won't come back, I promise!)
                </div>
              )}

              <div className="ml-10 text-lg mt-4 font-outfit">
                {showBookmarked
                  ? bookmarkedItems.length > 0
                    ? bookmarkedItems.length + ' Search Result(s)'
                    : 'Looks like you got no bookmarks ):'
                  : props.ecArray.length + ' Search Results'}
              </div>
                ...
                {tagsArray.map((tag) => {
                  return (
                    <div
                      ...
                      className="p-2 bg-blue-300 w-max font-outfit rounded-md shadow-sm flex items-center justify-between gap-2">
                      <div>{tag}</div>{' '}
                      <XCircleIcon className="dropdown-main mr-0 text-blue-700 hover:text-black" />
                    </div>
                  );
                })}
              </div>
              ...
              <div className="w-full p-4 px-8 h-max flex-col gap-2 flex justify-center">
                {' '}
                {/* Main EC holder */}
                {props.ecArray.length === 0 ? (
                  ...
                  (showBookmarked ? bookmarkedItems : props.ecArray).map(
                    (ec) => (
                      <ECItem
                        key={ec.id}
                        ec={ec}
