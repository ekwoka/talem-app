                    ...
                    <div className="col-span-3 shadow-[0_0_10px_-7px]">
                            ...
                            {showBanner &&                           
                                <div className="relative mx-8 bg-yellow-300 py-2 font-outfit px-6 rounded-lg text-yellow-800 text-center shadow-md">
                                    ...
                                    Hi there, I'm Pranav! I'm the developer of <span className="text-blue-500">Talem</span> and I'm glad you're using it/finding it useful! If you want to support me 
