...
export default function Extracurriculars(props) {
    ...
    let [advertState, setAdvertState] = useState(false)
                    ...
                    <div className="col-span-3 shadow-[0_0_10px_-7px]">
                            ...
                            <div className="relative flex">
                                ...
                                <div className="w-full p-7">
                                    <input type="search" id="default-search" onChange={props.searchChange} className="w-full p-4 pl-10 text-base text-gray-900 border border-none shadow-xl rounded-lg bg-slate-100 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 font-outfit" placeholder="Search for a specific extracurricular (Ex: Robotics)" required />
