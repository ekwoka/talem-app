...
import { FaBullseye, FaLightbulb, FaUserGraduate } from 'react-icons/fa';
...
const AboutPage = () => {
  const statistics = [
    {
      title:
        'Daily users use our platform to help find extracurriculars everyday.',
      value: '120+',
      details:
        'According to our analytics, over 100 users use Talem everyday to help them find the perfect extracurricular/internship opportunities.',
    },
    {
      title:
        'Extracurriculars/Internships in our database with more added daily.',
      value: '100+',
      details:
        'Our Extracurricular and Internship Database is always growing and expanding. You can submit your own activity as well!',
    },
    {
      title: 'Students have used Talem since its public release',
      value: '1,400+',
      details:
        'Since Talem went public on July 13th, over 1,000 different individuals have used the website as a source to gain information about highschool extracurriculars and internships',
    },
  ];
  ...
  const handleToggleDetails = (index) => {
    if (expandedStatistics.includes(index)) {
      setExpandedStatistics(
        expandedStatistics.filter((item) => item !== index),
      );
    } else {
  ...
  const firststatistics = [
    {
      percentage: '32%',
      description:
        'of students from low-income families participate in at least one extracurricular activity during high school, compared to 61% of students from higher-income families.',
      source:
        "Child Trends. (2020). 'Indicators of School Crime and Safety: 2019.",
      soureLink: 'https://nces.ed.gov/pubs2020/2020063.pdf',
    },
    {
      percentage: '45%',
      description:
        'of students from underrepresented communities lack access to quality extracurricular opportunities during high school.',
      source:
        "National Center for Education Statistics. (2021). 'The Condition of Education 2021.'",
      soureLink: 'https://nces.ed.gov/pubs2021/2021144.pdf',
    },
    {
      percentage: '63%',
      description:
        'of students from rural areas have limited access to extracurricular activities and educational resources.',
      source:
        "U.S. Department of Education. (2018). 'Rural Education Toolkit.'",
      soureLink:
        ...
        <div className="mx-4 md:mx-20 lg:mx-60 rounded-lg shadow-lg flex justify-center items-center bg-gradient-to-r from-purple-700 via-indigo-700 to-blue-700 p-5">
          <div className="text-center w-2/3">
            ...
            <p className="mt-4 text-lg text-white">
              At Talem, we aim to provide equal access to quality
              extracurricular opportunities for all high school students. Our
              mission is to empower students to explore their passions, develop
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {firststatistics.map((statistic, index) => (
              <div key={index} className="bg-gray-100 p-8 rounded-lg shadow-lg">
                <div className="text-5xl font-bold text-purple-700 font-outfit">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {statistics.map((statistic, index) => (
              <div
                ...
                <h3 className="text-5xl font-bold text-purple-700 font-outfit">
                  {statistic.value}
                </h3>
                ...
                {expandedStatistics.includes(index) && (
                  <p className="mt-4 text-base text-gray-600 font-outfit">
                    {statistic.details}
                  </p>
                )}
                <button
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 ">
          <div className="text-center flex justify-center flex-col items-center">
            ...
            <p className="mt-4 text-lg text-gray-600 w-2/3">
              We are committed to providing high school students with an
              exceptional platform for discovering and engaging in
              extracurricular activities and internships. Here's why Talem is
          ...
          <div className="grid grid-cols-1 gap-4 mt-12 md:grid-cols-2 lg:grid-cols-4 bg-gradient-to-r from-purple-700 via-indigo-700 to-blue-700 p-10 rounded-xl">
            <div className="flex items-center justify-evenly p-4 bg-white rounded-lg shadow-lg text-center gap-2">
              ...
              <p className="text-lg font-outfit font-medium text-gray-900">
