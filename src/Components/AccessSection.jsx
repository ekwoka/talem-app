            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 items-center">
              <div className="col-span-7">
                ...
                <p className="mt-4 text-lg text-gray-300">
                  Only a fraction of high schoolers have access to quality
                  extracurricular opportunities. At Talem, we are working to
                  change that by providing a platform that connects students to
                  a wide range of enriching activities.
                </p>
