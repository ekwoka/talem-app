...
const features = [
  ...
  },
  {
    name: 'Free Forever.',
    description:
      'Talem will always be free and stay free. We are committed to make sure every highschooler has the equal chance of getting the information they deserve.',
    icon: LockClosedIcon,
  },
  {
    name: 'Built with your help.',
    description:
      'Talem was built with YOUR suggestions and feedback. You can help us out by submitting an activity or joining our discord server!',
    icon: ServerIcon,
  },
];
          ...
          <div className="lg:pr-8 lg:pt-4 col-span-5 flex justify-center items-center">
            <div className="lg:max-w-lg px-4">
              <h2 className="text-base font-semibold leading-7 text-indigo-600">
                Pure data at your fingertips.
              </h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                No Paywall, No Sign-Up required.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                It seems like these days, everything is hidden behind a paywall.
                Talem is{' '}
                <span className="font-bold">
                  100% free and <span className="underline">always</span> will
                  be.{' '}
                </span>
                We believe that every high schooler should have{' '}
                <span className="underline">equal</span> access to
                opportunities.
              </p>
