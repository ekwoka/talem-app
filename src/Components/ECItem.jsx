...
const ECItem = ({ ec, handleBookmark, bookmarkedItems }) => (
    <LazyLoad offsetVertical={100} threshold={0.5}>
      <div className="shadow-lg rounded-lg bg-white grid grid-cols-1 lg:grid-cols-4 my-2" key={ec.id}>
        {/* Individual EC Item holder */}
        <div className="col-span-3 p-10 flex flex-col justify-evenly gap-3">
          {/* Col-span-3 EC info */}
